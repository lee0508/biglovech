...
if ( ! class_exists( 'Themify_Builder_Options' ) ) {
	...
	class Themify_Builder_Options {
		...
		function builder_show_all_google_fonts() {
			...
			$out = sprintf( '<p><label><input type="radio" name="%1$s" value="disabled" %7$s>%6$s</label></p><p><label><input type="radio" name="%1$s" value="less" %4$s>%2$s</label></p><p><label><input type="radio" name="%1$s" value="full" %5$s>%3$s</label></p>'
				...
				, __( 'Disable Google fonts', 'themify' )
				, checked( 'disabled', $current_value, false )
			);
